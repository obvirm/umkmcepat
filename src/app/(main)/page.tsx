...
function TemplatePreview({ template, index }: { template: (typeof templates)[number]; index: number }) {
  return (
    <article className="group overflow-hidden rounded-radius-3xl border border-foreground-primary/10 bg-surface-warm-white lovable-shadow-subtle transition duration-300 hover:-translate-y-0.5">
      <div className="aspect-[4/3] bg-surface-base p-3 sm:p-4">
        <div className="flex h-full flex-col rounded-radius-2xl border border-foreground-primary/10 bg-surface-warm-white p-4">
          ...
          <div className="mt-4 grid flex-1 grid-cols-[1.1fr_0.9fr] gap-3">
            <div className="flex flex-col">
              <div className="h-8 rounded-radius-xl bg-foreground-primary/12" />
              <div className="mt-2 h-3 w-3/4 rounded-full bg-foreground-primary/10" />
              <div className="mt-1.5 h-3 w-1/2 rounded-full bg-foreground-primary/8" />
              <div className="mt-auto h-8 w-24 rounded-radius-xl bg-action-primary" />
            </div>
            <div className="grid grid-rows-2 gap-2">
              <div className="rounded-radius-2xl bg-foreground-primary/10" />
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-radius-2xl bg-foreground-primary/8" />
                <div className="rounded-radius-2xl bg-foreground-primary/8" />
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-2">
            <div className="h-8 rounded-radius-xl border border-foreground-primary/10 bg-surface-warm-white" />
            <div className="h-8 rounded-radius-xl border border-foreground-primary/10 bg-surface-warm-white" />
            <div className="h-8 rounded-radius-xl border border-foreground-primary/10 bg-surface-warm-white" />
          </div>
        </div>
    ...
    <div className="min-h-screen bg-surface-base text-foreground-primary">
      <section className="lovable-aurora px-4 pb-12 pt-14 sm:px-6 sm:pb-16 sm:pt-16 lg:px-spacing-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center text-center">
          ...
          <div className="mt-8 w-full max-w-4xl rounded-radius-3xl border border-foreground-primary/12 bg-surface-warm-white p-2 lovable-shadow-subtle">
            <div className="grid overflow-hidden rounded-radius-2xl border border-foreground-primary/10 bg-surface-warm-white text-left lg:grid-cols-[1.15fr_0.85fr]">
              <div className="p-5 sm:p-spacing-9">
                ...
                <textarea
                  ...
                  className="h-28 w-full resize-none bg-transparent text-base leading-7 text-foreground-primary outline-none sm:text-lg lg:h-32"
                ...
                <div className="flex flex-col gap-3 border-t border-foreground-primary/10 pt-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Button asChild className="h-11 rounded-radius-lg bg-action-primary px-spacing-8 text-surface-warm-white hover:bg-action-primary/90 focus-visible:ring-2 focus-visible:ring-action-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface-warm-white">
                    <Link href="/create">Buat halaman</Link>
                  </Button>
                </div>
              </div>

              <div className="border-t border-foreground-primary/10 bg-surface-warm-white/72 p-5 lg:border-l lg:border-t-0 sm:p-spacing-9">
                <p className="text-sm text-text-secondary">Preview hasil</p>
                <div className="mt-4 rounded-radius-xl border border-foreground-primary/10 bg-surface-base p-4">
                  <div className="h-4 w-28 rounded-full bg-foreground-primary/14" />
                  <div className="mt-5 h-10 rounded-radius-xl bg-foreground-primary/12" />
                  <div className="mt-3 grid grid-cols-3 gap-2">
                    <div className="h-14 rounded-radius-xl bg-foreground-primary/8" />
                    <div className="h-14 rounded-radius-xl bg-foreground-primary/8" />
                    <div className="h-14 rounded-radius-xl bg-foreground-primary/8" />
                  </div>
                  <div className="mt-4 flex items-center justify-between">
                    <div className="h-3 w-24 rounded-full bg-foreground-primary/10" />
                    <div className="h-8 w-20 rounded-radius-xl bg-action-primary" />
                  </div>
                </div>
      ...
      <section aria-label="Teknologi dan prinsip" className="border-y border-foreground-primary/10 bg-surface-warm-white/45 px-4 py-5 sm:px-6 lg:px-spacing-10">
      ...
      <section id="templates" className="scroll-mt-24 px-4 py-16 sm:px-6 sm:py-24 lg:px-spacing-10">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid gap-spacing-7 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <section id="cara-kerja" className="scroll-mt-24 px-4 pb-16 sm:px-6 sm:pb-24 lg:px-spacing-10">
        <div className="mx-auto max-w-6xl border-t border-foreground-primary/10 pt-14 sm:pt-20">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="grid gap-spacing-9 md:grid-cols-3">
      ...
      <section id="open-source" className="scroll-mt-24 px-4 pb-20 sm:px-6 sm:pb-28 lg:px-spacing-10">
        <div className="mx-auto grid max-w-6xl gap-spacing-10 rounded-radius-3xl border border-foreground-primary/10 bg-surface-warm-white p-spacing-9 lovable-shadow-subtle sm:p-spacing-10 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
            ...
            <Button asChild variant="outline" className="h-11 rounded-radius-lg border-foreground-primary/12 bg-surface-warm-white px-spacing-8 text-foreground-primary hover:bg-surface-muted focus-visible:ring-2 focus-visible:ring-action-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface-warm-white">
